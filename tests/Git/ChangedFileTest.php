...
use Butschster\GitHooks\Git\ChangedFile;
...
class ChangedFileTest extends TestCase
{
     ...
     */
    function test_gets_file_meta(string $file, bool $isAdded, bool $isModified, bool $isDeleted, bool $isUntracked, bool $inCommit)
    {
